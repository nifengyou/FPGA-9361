...
begin
	if ( Reset == 1'b1 )
		...
		// BBPLL Control Registers 03F Through 04F
			10'h045: Config_data_wr_1byte <= 8'h00;      // Ref Frequency Scaler, set to x1, i.e., Fref = 1 x 40MHz = 40MHz
			...
			10'h04E: Config_data_wr_1byte <= 8'h10;		 // SDM Control 3
		  	10'h043: Config_data_wr_1byte <= 8'h29;      // Fractional BB Frequency Word(041 - 043): 92E14(H)
			10'h042: Config_data_wr_1byte <= 8'h5C;		
		  	10'h041: Config_data_wr_1byte <= 8'h12;	
			10'h044: Config_data_wr_1byte <= 8'h18;      // Integer BB Freq Word			
			10'h03F: if ( Cnt_addr_03f == 1'b1 )
		...
		case ( Config_addr_1byte )
			10'h002: Config_data_wr_1byte <= 8'hCE;      // Enable Tx1 and shutdown Tx2
			10'h003: Config_data_wr_1byte <= 8'hDE;      // Enable Rx1 and shutdown Rx2
