...
AD80305_SPI_INTF	U_AD80305_SPI_INTF
	...
	.Rx_data_delay			( 4'hE                      ),      //* 0.3ns/LSB, so the RX data delay = Rx_data_delay * 0.3ns
...
*/
assign Ad80305_fb_clk_p = Ad80305_data_clk_p;
assign Ad80305_tx_frame_p = Ad80305_rx_frame_p;
assign Ad80305_p1_d = Ad80305_p0_d;
/*****************************************************/
/*-------               Test Code            --------*/
/*****************************************************/
//* Pass Through Mode
...
//* Transmit a single tone (LO-frequency) signal, leave Rx unused, for testing Tx channel
//assign Data_out_i_ad80305 = 12'h400;
//assign Data_out_q_ad80305 = 12'h400;
