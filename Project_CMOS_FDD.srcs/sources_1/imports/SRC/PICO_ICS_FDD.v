...
reg	[11:0]	Data_out_i_ad80305_reg;				
reg	[11:0]	Data_out_q_ad80305_reg;				
...
begin
    ...
    begin
        ...
        Ad80305_rxgain  = 7'd0;  //* initial 7'd34
        Ad80305_txgain  = 9'd0;
    end
    else
        ;
...
//*
wire    [25:0]  Data_DDR_IN;    // wire from DATA_INTF_RX to test DDR IP core
wire            Clk_DDR_IN;     // wire from DATA_INTF_RX to test DDR IP core
...
ila_0               U_ILA_RX_IQ
	...
	.probe0     ( Ad80305_data_clk_p    ), // input wire [0:0]  probe0  
    .probe1     ( Ad80305_rx_frame_p    ), // input wire [0:0]  probe1 
    .probe2     ( Ad80305_p0_d          ), // input wire [11:0]  probe2 
    .probe3     ( Clk_DDR_IN            ), // input wire [0:0]  probe3 
    .probe4     ( Data_DDR_IN           ), // input wire [25:0]  probe4 
    .probe5     ( Data_in_i_ad80305     ), // input wire [11:0]  probe5 
    .probe6     ( Data_in_q_ad80305     ) // input wire [11:0]  probe6
    );
...
begin
    if( MODSET == 3'b000 )
        begin
            Data_out_i_ad80305_reg <= Data_in_i_ad80305; //* Pass Through Mode
            Data_out_q_ad80305_reg <= Data_in_q_ad80305;
        end
    else if( MODSET == 3'b001 )
        begin
            Data_out_i_ad80305_reg <= I_symb;   //* Generate Barker Code as I/Q source bit-stream
            Data_out_q_ad80305_reg <= Q_symb;
        end
    else if( MODSET == 3'b010 )
        begin
            Data_out_i_ad80305_reg <= 12'h400;   //* Transmit a single tone (LO-frequency) signal, leave Rx unused, for testing Tx channel
            Data_out_q_ad80305_reg <= 12'h400;
        end
    else if( MODSET == 3'b011 )
                begin
                    Data_out_i_ad80305_reg <= Cnt_IQ;
                    Data_out_q_ad80305_reg <= Cnt_IQ;
                end
    else
        begin
            Data_out_i_ad80305_reg <= 12'd0;
            Data_out_q_ad80305_reg <= 12'd0;
        end     
end

assign Data_out_i_ad80305 = Data_out_i_ad80305_reg;
assign Data_out_q_ad80305 = Data_out_q_ad80305_reg;
